    ...
    >
      ...
      >
        <div
          ...
          className="flex h-full w-full flex-col rounded-lg bg-sidebar p-4 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "size-7 border border-gray-200 bg-white text-gray-500",
        className,
      )}
      onClick={(event) => {
        onClick?.(event);
